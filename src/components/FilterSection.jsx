                    ...
                    <div className='row'>
                        ...
                        <Form >
                            <Form.Group className="mb-2" controlId="formBasicEmail">
                                ...
                                <select class="form-select" onChange={handleChanges} value={cabin_class} name='cabin_class' aria-label="Default select example">
                            ...
                            <Form.Group className="mb-2" controlId="formBasicEmail">
                                ...
                                <select class="form-select" aria-label="Default select example" name='airline' onChange={handleChanges} value={airline}>
